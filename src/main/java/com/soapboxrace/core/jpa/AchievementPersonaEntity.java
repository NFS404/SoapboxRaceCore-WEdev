...
public class AchievementPersonaEntity {
	...
	public void setExtraLVL(int extraLVL) {
	...
	public int getAftermarketSold() {
		return aftermarketSold;
	}
	...
	public int getSBAgeTaken() {
		return sbAgeTaken;
	}

	public void setSBAgeTaken(int sbAgeTaken) {
		this.sbAgeTaken = sbAgeTaken;
	}
	
	public int getCollectorCars() {
		return collectorCars;
	}

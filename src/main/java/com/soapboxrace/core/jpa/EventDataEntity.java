...
@NamedQueries({ //
		...
		@NamedQuery(name = "EventDataEntity.getRacersRanked", query = "SELECT obj FROM EventDataEntity obj WHERE obj.eventSessionId = :eventSessionId ORDER BY obj.rank ASC"), //

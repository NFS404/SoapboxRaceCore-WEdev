...
public class EventsBO {
	...
	private Accolades getTreasureHuntAccolades(Long activePersonaId, TreasureHuntEntity treasureHuntEntity) {
		...
		Accolades accolades = rewardBO.getAccolades(personaEntity, arbitrationPacket, rewardVO, 2);
	...
	private LuckyDrawInfo getLuckyDrawInfo(TreasureHuntEntity treasureHuntEntity) {
		...
		arrayOfLuckyDrawItem.getLuckyDrawItem().add(rewardBO.getItemFromProduct(personaDao.findById(treasureHuntEntity.getPersonaId()), "thunt", 2));

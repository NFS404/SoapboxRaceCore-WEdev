...
//			}
	...
	public CommerceResultStatus buyCarRandom(String productId, PersonaEntity personaEntity) {
		...
		String[] productIdGoodArray = { "SRV-CAR24","SRV-CAR370","SRV-CAR125","SRV-CAR307","SRV-CAR104","SRV-CAR111","SRV-CAR94","SRV-CAR3",
				...
				"SRV-BRERA1","SRV-CAR239","SRV-FCAR30", "SRV-FCAR7", "SRV-FCAR32", "SRV-FCAR36", "SRV-FCAR37", "SRV-FCAR38", "SRV-FCAR40",
				"SRV-CAR380", "SRV-CAR381", "SRV-CAR382", "SRV-FCAR39" }; // "SRV-FCAR11", "SRV-FCAR8" - MW'05 cop & firetruck
		String[] productIdBadArray = { "SRV-CAR40","SRV-CAR151","SRV-CAR165","SRV-CAR143","SRV-CAR154","SRV-CAR173","SRV-CAR141","SRV-CAR142",
				...
				"SRV-CAR177","SRV-CAR145","SRV-CAR157","SRV-CAR36","SRV-CAR175","SRV-CAR161","SRV-FCAR29","SRV-FCAR31", "SRV-FCAR33", "SRV-FCAR34" };
